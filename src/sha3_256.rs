...
pub fn SymCryptSha3_256(pbData: &[u8], cbData: usize, pbResult: &mut [u8]) {
    ...
    SymCryptSha3_256Init(std::slice::from_mut::<
        crate::symcrypt_internal::SYMCRYPT_SHA3_256_STATE,
    >(&mut state));
...
pub const sha3_256KATAnswer: [u8; 32] = [
    ...
    189u8, 133u8, 95u8, 8u8, 110u8, 62u8, 157u8, 82u8, 91u8, 70u8, 191u8, 226u8, 69u8, 17u8, 67u8,
    21u8, 50u8,
];
