...
const SYMCRYPT_SHA3_256_INPUT_BLOCK_SIZE: usize =    136;

const SYMCRYPT_SHA3_512_RESULT_SIZE: usize =         64;
const SYMCRYPT_SHA3_512_INPUT_BLOCK_SIZE: usize =    72;
...
extern "C" {
    ...
    fn SymCryptSha3_256(pbData: *const u8, cbData: usize, pbResult: &mut [u8; SYMCRYPT_SHA3_256_RESULT_SIZE]);
    ...
    fn SymCryptSha3_256Result(pState: &mut HASH_STATE, pbResult: &mut [u8; SYMCRYPT_SHA3_256_RESULT_SIZE]);
    fn SymCryptSha3_256StateCopy(pSrc: & HASH_STATE, pDst: &mut HASH_STATE);

    fn SymCryptSha3_512(pbData: *const u8, cbData: usize, pbResult: &mut [u8; SYMCRYPT_SHA3_512_RESULT_SIZE]);
    ...
    fn SymCryptSha3_512Result(pState: &mut HASH_STATE, pbResult: &mut [u8; SYMCRYPT_SHA3_512_RESULT_SIZE]);
...
pub(crate) fn sha3_256(pbData: &[u8], pbResult: &mut [u8; SYMCRYPT_SHA3_256_RESULT_SIZE]) {
    unsafe {
...
pub(crate) fn sha3_256_result(pState: &mut HASH_STATE, pbResult: &mut [u8; SYMCRYPT_SHA3_256_RESULT_SIZE]) {
    unsafe {
...
pub(crate) fn sha3_512(pbData: &[u8], pbResult: &mut [u8; SYMCRYPT_SHA3_512_RESULT_SIZE]) {
    unsafe {
...
pub(crate) fn sha3_512_result(pState: &mut HASH_STATE, pbResult: &mut [u8; SYMCRYPT_SHA3_512_RESULT_SIZE]) {
    unsafe {
