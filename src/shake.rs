...
pub fn SymCryptShake128(pbData: &[u8], cbData: usize, pbResult: &mut [u8], cbResult: usize) {
    ...
    SymCryptShake128Init(std::slice::from_mut::<
        crate::symcrypt_internal::SYMCRYPT_SHAKE128_STATE,
    >(&mut state));
...
pub fn SymCryptShake256(pbData: &[u8], cbData: usize, pbResult: &mut [u8], cbResult: usize) {
    ...
    SymCryptShake256Init(std::slice::from_mut::<
        crate::symcrypt_internal::SYMCRYPT_SHAKE256_STATE,
    >(&mut state));
