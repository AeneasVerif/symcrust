...
pub fn SymCryptSha3_224(pbData: &[u8], cbData: usize, pbResult: &mut [u8]) {
    ...
    SymCryptSha3_224Init(std::slice::from_mut::<
        crate::symcrypt_internal::SYMCRYPT_SHA3_224_STATE,
    >(&mut state));
...
pub const sha3_224KATAnswer: [u8; 28] = [
    ...
    118u8, 111u8, 201u8, 163u8, 165u8, 22u8, 141u8, 12u8, 148u8, 173u8, 115u8, 180u8, 111u8, 223u8,
];
