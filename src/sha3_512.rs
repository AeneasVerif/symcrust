...
pub fn SymCryptSha3_512(pbData: &[u8], cbData: usize, pbResult: &mut [u8]) {
    ...
    SymCryptSha3_512Init(std::slice::from_mut::<
        crate::symcrypt_internal::SYMCRYPT_SHA3_512_STATE,
    >(&mut state));
...
pub const sha3_512KATAnswer: [u8; 64] = [
    ...
    110u8, 8u8, 246u8, 33u8, 130u8, 116u8, 68u8, 247u8, 13u8, 136u8, 79u8, 93u8, 2u8, 64u8, 210u8,
    113u8, 46u8, 16u8, 225u8, 22u8, 233u8, 25u8, 42u8, 243u8, 201u8, 26u8, 126u8, 197u8, 118u8,
    71u8, 227u8, 147u8, 64u8, 87u8, 52u8, 11u8, 76u8, 244u8, 8u8, 213u8, 165u8, 101u8, 146u8,
    248u8, 39u8, 78u8, 236u8, 83u8, 240u8,
];
