...
pub fn SymCryptSha3_384(pbData: &[u8], cbData: usize, pbResult: &mut [u8]) {
    ...
    SymCryptSha3_384Init(std::slice::from_mut::<
        crate::symcrypt_internal::SYMCRYPT_SHA3_384_STATE,
    >(&mut state));
...
pub const sha3_384KATAnswer: [u8; 48] = [
    ...
    173u8, 141u8, 249u8, 180u8, 115u8, 203u8, 15u8, 192u8, 140u8, 37u8, 150u8, 218u8, 124u8, 240u8,
    228u8, 155u8, 228u8, 178u8, 152u8, 216u8, 140u8, 234u8, 146u8, 122u8, 199u8, 245u8, 57u8,
    241u8, 237u8, 242u8, 40u8, 55u8, 109u8, 37u8,
];
