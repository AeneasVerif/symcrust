...
#[inline(always)]
pub fn KECCAK_CHI(state: &mut [u64]) {
...
#[inline(always)]
pub fn KECCAK_CHI_ROW(state: &mut [u64], r: i32) {
    let t1: u64 = state[5i32.wrapping_mul(r).wrapping_add(0i32) as usize]
        ^ !state[5i32.wrapping_mul(r).wrapping_add(1i32) as usize]
            & state[5i32.wrapping_mul(r).wrapping_add(2i32) as usize];
    let t2: u64 = state[5i32.wrapping_mul(r).wrapping_add(1i32) as usize]
        ^ !state[5i32.wrapping_mul(r).wrapping_add(2i32) as usize]
            & state[5i32.wrapping_mul(r).wrapping_add(3i32) as usize];
    state[5i32.wrapping_mul(r).wrapping_add(2i32) as usize] ^= !state
        [5i32.wrapping_mul(r).wrapping_add(3i32) as usize]
        & state[5i32.wrapping_mul(r).wrapping_add(4i32) as usize];
    state[5i32.wrapping_mul(r).wrapping_add(3i32) as usize] ^= !state
        [5i32.wrapping_mul(r).wrapping_add(4i32) as usize]
        & state[5i32.wrapping_mul(r).wrapping_add(0i32) as usize];
    state[5i32.wrapping_mul(r).wrapping_add(4i32) as usize] ^= !state
        [5i32.wrapping_mul(r).wrapping_add(0i32) as usize]
        & state[5i32.wrapping_mul(r).wrapping_add(1i32) as usize];
...
#[inline(always)]
pub fn KECCAK_COLUMN_SUM(state: &[u64], c: usize) -> u64 {
    return state[0u64.wrapping_add(c as u64) as usize]
        ^ state[5u64.wrapping_add(c as u64) as usize]
...
#[inline(always)]
pub fn KECCAK_COLUMN_UPDATE(state: &mut [u64], c: usize, w: u64) {
    let t: u64 = w;
...
#[inline(always)]
pub fn KECCAK_IOTA(state: &mut [u64], rnd: i32) {
    state[0usize] ^= KeccakIotaK[rnd as usize]
}

#[inline(always)]
pub fn KECCAK_PERM_ROUND(state: &mut [u64], rnd: i32) {
    KECCAK_THETA(state);
    KECCAK_RHO(state);
    KECCAK_PI(state);
    KECCAK_CHI(state);
...
#[inline(always)]
pub fn KECCAK_PI(state: &mut [u64]) {
...
#[inline(always)]
pub fn KECCAK_RHO(state: &mut [u64]) {
...
#[inline(always)]
pub fn KECCAK_RHO_ROW(state: &mut [u64], r: i32) {
    state[5i32.wrapping_mul(r).wrapping_add(0i32) as usize] = ((state
        [5i32.wrapping_mul(r).wrapping_add(0i32) as usize])
        .wrapping_shl(KeccakRhoK[5i32.wrapping_mul(r).wrapping_add(0i32) as usize] as u32)
    ...
    state[5i32.wrapping_mul(r).wrapping_add(1i32) as usize] = ((state
        [5i32.wrapping_mul(r).wrapping_add(1i32) as usize])
        .wrapping_shl(KeccakRhoK[5i32.wrapping_mul(r).wrapping_add(1i32) as usize] as u32)
    ...
    state[5i32.wrapping_mul(r).wrapping_add(2i32) as usize] = ((state
        [5i32.wrapping_mul(r).wrapping_add(2i32) as usize])
        .wrapping_shl(KeccakRhoK[5i32.wrapping_mul(r).wrapping_add(2i32) as usize] as u32)
    ...
    state[5i32.wrapping_mul(r).wrapping_add(3i32) as usize] = ((state
        [5i32.wrapping_mul(r).wrapping_add(3i32) as usize])
        .wrapping_shl(KeccakRhoK[5i32.wrapping_mul(r).wrapping_add(3i32) as usize] as u32)
    ...
    state[5i32.wrapping_mul(r).wrapping_add(4i32) as usize] = ((state
        [5i32.wrapping_mul(r).wrapping_add(4i32) as usize])
        .wrapping_shl(KeccakRhoK[5i32.wrapping_mul(r).wrapping_add(4i32) as usize] as u32)
...
#[inline(always)]
pub fn KECCAK_RHO_ROW0(state: &mut [u64]) {
    state[1usize] = ((state[1usize]).wrapping_shl(KeccakRhoK[1usize] as u32)
        | (state[1usize]).wrapping_shr(64i32.wrapping_sub(KeccakRhoK[1usize] as i32) as u32))
        as u64;
    state[2usize] = ((state[2usize]).wrapping_shl(KeccakRhoK[2usize] as u32)
        | (state[2usize]).wrapping_shr(64i32.wrapping_sub(KeccakRhoK[2usize] as i32) as u32))
        as u64;
    state[3usize] = ((state[3usize]).wrapping_shl(KeccakRhoK[3usize] as u32)
        | (state[3usize]).wrapping_shr(64i32.wrapping_sub(KeccakRhoK[3usize] as i32) as u32))
        as u64;
    state[4usize] = ((state[4usize]).wrapping_shl(KeccakRhoK[4usize] as u32)
        | (state[4usize]).wrapping_shr(64i32.wrapping_sub(KeccakRhoK[4usize] as i32) as u32))
        as u64
}

#[inline(always)]
pub fn KECCAK_THETA(state: &mut [u64]) {
...
pub const KeccakIotaK: [u64; 24] = [
    1u64,
    32898u64,
    9223372036854808714u64,
    9223372039002292224u64,
    32907u64,
    2147483649u64,
    9223372039002292353u64,
    9223372036854808585u64,
    138u64,
    136u64,
    2147516425u64,
    2147483658u64,
    2147516555u64,
    9223372036854775947u64,
    9223372036854808713u64,
    9223372036854808579u64,
    9223372036854808578u64,
    9223372036854775936u64,
    32778u64,
    9223372039002259466u64,
    9223372039002292353u64,
    9223372036854808704u64,
    2147483649u64,
...
pub fn SymCryptKeccakAppend(
    ...
    if (pState[0usize]).squeezeMode != 0u8 {
        SymCryptKeccakReset(pState)
    };
    while cbData > 0usize && (pState[0usize]).stateIndex & 7u32 != 0u32 {
...
#[inline]
pub fn SymCryptKeccakAppendByte(
    pState: &mut [crate::symcrypt_internal::SYMCRYPT_KECCAK_STATE],
    val: u8,
) {
    (pState[0usize]).state[(pState[0usize]).stateIndex.wrapping_div(8u32) as usize] ^= (val as u64)
        .wrapping_shl(8u32.wrapping_mul((pState[0usize]).stateIndex.wrapping_rem(8u32)));
    (pState[0usize]).stateIndex = (pState[0usize]).stateIndex.wrapping_add(1u32)
}

#[inline]
pub fn SymCryptKeccakAppendBytes(
    pState: &mut [crate::symcrypt_internal::SYMCRYPT_KECCAK_STATE],
    pbBuffer: &[u8],
    cbBuffer: usize,
) {
    for i in 0usize..cbBuffer {
        (pState[0usize]).state[(pState[0usize])
            .stateIndex
            .wrapping_add(i as u32)
            .wrapping_div(8u32) as usize] ^= (pbBuffer[i] as u64).wrapping_shl(
            8u64.wrapping_mul(
                (pState[0usize])
                    .stateIndex
                    .wrapping_add(i as u32)
                    .wrapping_rem(8u32) as u64,
            ) as u32,
        )
    }
...
pub fn SymCryptKeccakApplyPadding(pState: &mut [crate::symcrypt_internal::SYMCRYPT_KECCAK_STATE]) {
    ...
    (pState[0usize]).state[(pState[0usize])
        .inputBlockSize
        .wrapping_div(8u32)
        .wrapping_sub(1u32) as usize] ^= 1u64.wrapping_shl(63u32);
    SymCryptKeccakPermute(&mut (pState[0usize]).state);
    (pState[0usize]).stateIndex = 0u32;
...
pub fn SymCryptKeccakExtract(
    ...
    while cbResult > 0usize && (pState[0usize]).stateIndex & 7u32 != 0u32 {
...
#[inline]
pub fn SymCryptKeccakExtractByte(
    pState: &mut [crate::symcrypt_internal::SYMCRYPT_KECCAK_STATE],
) -> u8 {
    let ret: u8 = (((pState[0usize]).state
        [(pState[0usize]).stateIndex.wrapping_div(8u32) as usize])
        .wrapping_shr(8u32.wrapping_mul((pState[0usize]).stateIndex.wrapping_rem(8u32)))
        & 255u64) as u8;
    (pState[0usize]).stateIndex = (pState[0usize]).stateIndex.wrapping_add(1u32);
    return ret;
}
