...
poly_element_sample_ntt_from_shake128(symcrust_hash_HashState *p_state, uint16_t *pe_dst)
{
  ...
  while (i < SYMCRUST_KEY_MLWE_POLYNOMIAL_COEFFICIENTS)
  {
    ...
    symcrust_ntt_slice_to_sub_array((size_t)2U,
      ...
      ret,
      void *);
    uint16_t sample1 = (uint32_t)core_num__u16__from_le_bytes(ret) >> 4U;
...
with types uint16_t[256size_t]

*/
static void swap_2b_c3(Eurydice_slice s, size_t i, size_t j)
{
  uint16_t tmp[256U];
  memcpy(tmp,
    Eurydice_slice_index(s, i, uint16_t [256U], uint16_t (*)[256U]),
    (size_t)256U * sizeof (uint16_t));
  memcpy(Eurydice_slice_index(s, i, uint16_t [256U], uint16_t (*)[256U]),
    Eurydice_slice_index(s, j, uint16_t [256U], uint16_t (*)[256U]),
    (size_t)256U * sizeof (uint16_t));
  memcpy(Eurydice_slice_index(s, j, uint16_t [256U], uint16_t (*)[256U]),
    tmp,
    (size_t)256U * sizeof (uint16_t));
}
...
)
{
  ...
  symcrust_hash_sha3_512(Eurydice_array_to_subslice3(uu____3,
      (size_t)0U,
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)32U,
          pk_mlkem_key.ptr->header.private_seed,
          uint8_t),
  ...
  symcrust_hash_shake256_init(&p_comp_temps->hash_state0);
  symcrust_hash_HashState *uu____4 = &p_comp_temps->hash_state0;
  uint8_t *uu____5 = private_seed_hash;
  size_t
  uu____6 =
    Eurydice_slice_len(Eurydice_array_to_slice((size_t)32U,
        pk_mlkem_key.ptr->header.public_seed,
        uint8_t),
      uint8_t);
  symcrust_hash_shake256_append(uu____4,
    Eurydice_array_to_subslice3(uu____5,
      uu____6,
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)32U,
          pk_mlkem_key.ptr->header.public_seed,
          uint8_t),
  ...
  Eurydice_slice_uint16_t_256size_t__x3 uu____7 = symcrust_key_ats_mut_fd(pk_mlkem_key);
  Eurydice_slice a = uu____7.fst;
  Eurydice_slice t0 = uu____7.snd;
  uint32_t *pa_tmp = p_comp_temps->ab_poly_element_accumulator_buffer;
  ...
  tuple_48 uu____8 = symcrust_key_t_encoded_t_mut_fd(pk_mlkem_key);
  Eurydice_slice t = uu____8.fst;
  uint8_t *encoded_t = uu____8.snd;
              ...
              else
              {
                ...
                else
                {
                  ...
                  Eurydice_slice_copy(Eurydice_array_to_subslice3(pk_mlkem_key.ptr->header.encoded_t,
                    ...
                    uint8_t);
                  pb_curr = pb_curr + cb_encoded_vector;
                  tuple_48 uu____7 = symcrust_key_t_encoded_t_mut_fd(pk_mlkem_key);
                  Eurydice_slice t = uu____7.fst;
                  uint8_t *encoded_t = uu____7.snd;
                  symcrust_common_Error
                  sc_error0 =
              ...
              else
              {
                ...
                else
                {
                  ...
                  Eurydice_slice_copy(Eurydice_array_to_subslice3(pk_mlkem_key.ptr->header.encoded_t,
                    ...
                    uint8_t);
                  pb_curr = pb_curr + cb_encoded_vector;
                  tuple_48 uu____16 = symcrust_key_t_encoded_t_mut_fd(pk_mlkem_key);
                  Eurydice_slice t = uu____16.fst;
                  uint8_t *encoded_t = uu____16.snd;
                  symcrust_common_Error
                  sc_error0 =
                    vector_decode_and_decompress(Eurydice_array_to_subslice3(encoded_t,
                        (size_t)0U,
          ...
          case symcrust_key_Format_EncapsulationKey:
            {
              ...
              else
              {
                Eurydice_slice_copy(Eurydice_array_to_subslice3(pk_mlkem_key.ptr->header.encoded_t,
                  ...
                  uint8_t);
                pb_curr = pb_curr + cb_encoded_vector;
                tuple_48 uu____18 = symcrust_key_t_encoded_t_mut_fd(pk_mlkem_key);
                Eurydice_slice t = uu____18.fst;
                uint8_t *encoded_t = uu____18.snd;
                symcrust_common_Error
                sc_error =
                  vector_decode_and_decompress(Eurydice_array_to_subslice3(encoded_t,
                      (size_t)0U,
