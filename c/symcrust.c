...
*/
inline bool symcrust_common_eq_3d(symcrust_common_Error *self, symcrust_common_Error *other)
{
...
symcrust_common_fmt_06(symcrust_common_Error *self, core_fmt_Formatter *f)
{
  ...
  symcrust_common_Error scrut = self[0U];
  if (scrut == symcrust_common_Error_NoError)
  {
    uu____1 = "NoError";
  }
  ...
  {
    uu____1 = "WrongKeySize";
  }
  else if (scrut == symcrust_common_Error_WrongBlockSize)
  {
    uu____1 = "WrongBlockSize";
  }
  else if (scrut == symcrust_common_Error_WrongDataSize)
  {
    uu____1 = "WrongDataSize";
  }
  else if (scrut == symcrust_common_Error_WrongNonceSize)
  {
    uu____1 = "WrongNonceSize";
  }
  else if (scrut == symcrust_common_Error_WrongTagSize)
  {
    uu____1 = "WrongTagSize";
  }
  else if (scrut == symcrust_common_Error_WrongIterationCount)
  {
    uu____1 = "WrongIterationCount";
  }
  else if (scrut == symcrust_common_Error_AuthenticationFailure)
  {
    uu____1 = "AuthenticationFailure";
  }
  else if (scrut == symcrust_common_Error_ExternalFailure)
  {
    uu____1 = "ExternalFailure";
  }
  else if (scrut == symcrust_common_Error_FipsFailure)
  {
    uu____1 = "FipsFailure";
  ...
  {
    uu____1 = "HardwareFailure";
  }
  else if (scrut == symcrust_common_Error_NotImplemented)
  {
    uu____1 = "NotImplemented";
  }
  else if (scrut == symcrust_common_Error_InvalidBlob)
  {
    uu____1 = "InvalidBlob";
  ...
  {
    uu____1 = "BufferTooSmall";
  }
  else if (scrut == symcrust_common_Error_InvalidArgument)
  {
    uu____1 = "InvalidArgument";
  }
  else if (scrut == symcrust_common_Error_MemoryAllocationFailure)
  {
    uu____1 = "MemoryAllocationFailure";
  }
  else if (scrut == symcrust_common_Error_SignatureVerificationFailure)
  {
    uu____1 = "SignatureVerificationFailure";
  }
  else if (scrut == symcrust_common_Error_IncompatibleFormat)
  {
    uu____1 = "IncompatibleFormat";
  }
  else if (scrut == symcrust_common_Error_ValueTooLarge)
  {
    uu____1 = "ValueTooLarge";
  }
  else if (scrut == symcrust_common_Error_SessionReplayFailure)
  {
    uu____1 = "SessionReplayFailure";
  }
  else if (scrut == symcrust_common_Error_HbsNoOtsKeysLeft)
  {
    uu____1 = "HbsNoOtsKeysLeft";
  }
  else
  {
    uu____1 = "HbsPublicRootMismatch";
  }
  return core_fmt__core__fmt__Formatter__a__11__write_str(uu____0, uu____1);
}

void symcrust_hash_sha3_256(Eurydice_slice pb_data, uint8_t *pb_result)
{
  uint8_t *uu____0 = core_slice___Slice_T___as_ptr(pb_data, uint8_t, uint8_t *);
  symcrust_hash_SymCryptSha3_256(uu____0, Eurydice_slice_len(pb_data, uint8_t), pb_result);
}
...
void symcrust_hash_sha3_256_append(symcrust_hash_HashState *p_state, Eurydice_slice pb_data)
{
  ...
  uint8_t *uu____1 = core_slice___Slice_T___as_ptr(pb_data, uint8_t, uint8_t *);
  symcrust_hash_SymCryptSha3_256Append(uu____0, uu____1, Eurydice_slice_len(pb_data, uint8_t));
}

void symcrust_hash_sha3_256_init(symcrust_hash_HashState *p_state)
{
  symcrust_hash_SymCryptSha3_256Init(p_state);
}

void symcrust_hash_sha3_256_result(symcrust_hash_HashState *p_state, uint8_t *pb_result)
{
  symcrust_hash_SymCryptSha3_256Result(p_state, pb_result);
}
...
{
  symcrust_hash_SymCryptSha3_256StateCopy(p_src, p_dst);
}

void symcrust_hash_sha3_512(Eurydice_slice pb_data, uint8_t *pb_result)
{
  uint8_t *uu____0 = core_slice___Slice_T___as_ptr(pb_data, uint8_t, uint8_t *);
  symcrust_hash_SymCryptSha3_512(uu____0, Eurydice_slice_len(pb_data, uint8_t), pb_result);
}
...
void symcrust_hash_sha3_512_append(symcrust_hash_HashState *p_state, Eurydice_slice pb_data)
{
  symcrust_hash_HashState *uu____0 = p_state;
  uint8_t *uu____1 = core_slice___Slice_T___as_ptr(pb_data, uint8_t, uint8_t *);
  symcrust_hash_SymCryptSha3_512Append(uu____0, uu____1, Eurydice_slice_len(pb_data, uint8_t));
}

void symcrust_hash_sha3_512_init(symcrust_hash_HashState *p_state)
{
  symcrust_hash_SymCryptSha3_512Init(p_state);
}

void symcrust_hash_sha3_512_result(symcrust_hash_HashState *p_state, uint8_t *pb_result)
{
  symcrust_hash_SymCryptSha3_512Result(p_state, pb_result);
}
...
{
  symcrust_hash_SymCryptSha3_512StateCopy(p_src, p_dst);
}

void symcrust_hash_shake128(Eurydice_slice pb_data, Eurydice_slice pb_result)
{
  uint8_t *uu____0 = core_slice___Slice_T___as_ptr(pb_data, uint8_t, uint8_t *);
  size_t uu____1 = Eurydice_slice_len(pb_data, uint8_t);
  uint8_t *uu____2 = core_slice___Slice_T___as_mut_ptr(pb_result, uint8_t, uint8_t *);
  symcrust_hash_SymCryptShake128(uu____0,
    uu____1,
    uu____2,
    Eurydice_slice_len(pb_result, uint8_t));
}
...
void symcrust_hash_shake128_append(symcrust_hash_HashState *p_state, Eurydice_slice pb_data)
{
  symcrust_hash_HashState *uu____0 = p_state;
  uint8_t *uu____1 = core_slice___Slice_T___as_ptr(pb_data, uint8_t, uint8_t *);
  symcrust_hash_SymCryptShake128Append(uu____0, uu____1, Eurydice_slice_len(pb_data, uint8_t));
}

void symcrust_hash_shake128_default(Eurydice_slice data, uint8_t *dst)
{
  uint8_t *uu____0 = core_slice___Slice_T___as_ptr(data, uint8_t, uint8_t *);
  symcrust_hash_SymCryptShake128Default(uu____0, Eurydice_slice_len(data, uint8_t), dst);
}

void symcrust_hash_shake128_extract(symcrust_hash_HashState *st, Eurydice_slice dst, bool wipe)
{
  symcrust_hash_HashState *uu____0 = st;
  uint8_t *uu____1 = core_slice___Slice_T___as_mut_ptr(dst, uint8_t, uint8_t *);
  symcrust_hash_SymCryptShake128Extract(uu____0,
    uu____1,
    Eurydice_slice_len(dst, uint8_t),
    wipe);
}

void symcrust_hash_shake128_init(symcrust_hash_HashState *p_state)
{
  symcrust_hash_SymCryptShake128Init(p_state);
}

void symcrust_hash_shake128_result(symcrust_hash_HashState *p_state, uint8_t *pb_result)
{
  symcrust_hash_SymCryptShake128Result(p_state, pb_result);
}
...
{
  symcrust_hash_SymCryptShake128StateCopy(p_src, p_dst);
}
...
void symcrust_hash_shake256(Eurydice_slice pb_data, Eurydice_slice pb_result)
{
  ...
  size_t uu____1 = Eurydice_slice_len(pb_data, uint8_t);
  uint8_t *uu____2 = core_slice___Slice_T___as_mut_ptr(pb_result, uint8_t, uint8_t *);
  symcrust_hash_SymCryptShake256(uu____0,
    uu____1,
    uu____2,
    Eurydice_slice_len(pb_result, uint8_t));
}
...
void symcrust_hash_shake256_append(symcrust_hash_HashState *p_state, Eurydice_slice pb_data)
{
  symcrust_hash_HashState *uu____0 = p_state;
  uint8_t *uu____1 = core_slice___Slice_T___as_ptr(pb_data, uint8_t, uint8_t *);
  symcrust_hash_SymCryptShake256Append(uu____0, uu____1, Eurydice_slice_len(pb_data, uint8_t));
}

void symcrust_hash_shake256_default(Eurydice_slice data, uint8_t *dst)
{
  uint8_t *uu____0 = core_slice___Slice_T___as_ptr(data, uint8_t, uint8_t *);
  symcrust_hash_SymCryptShake256Default(uu____0, Eurydice_slice_len(data, uint8_t), dst);
}

void symcrust_hash_shake256_extract(symcrust_hash_HashState *st, Eurydice_slice dst, bool wipe)
{
  symcrust_hash_HashState *uu____0 = st;
  uint8_t *uu____1 = core_slice___Slice_T___as_mut_ptr(dst, uint8_t, uint8_t *);
  symcrust_hash_SymCryptShake256Extract(uu____0,
    uu____1,
    Eurydice_slice_len(dst, uint8_t),
    wipe);
}
...
{
  symcrust_hash_SymCryptShake256Init(p_state);
}

void symcrust_hash_shake256_result(symcrust_hash_HashState *p_state, uint8_t *pb_result)
{
  symcrust_hash_SymCryptShake256Result(p_state, pb_result);
}
...
{
  symcrust_hash_SymCryptShake256StateCopy(p_src, p_dst);
}
...
KRML_MUSTINLINE uint32_t symcrust_ntt_mod_reduce(uint32_t a)
{
  EURYDICE_ASSERT(a < 2U * SYMCRUST_NTT_Q, "panic!");
  uint32_t res = core_num__u32_8__wrapping_sub(a, SYMCRUST_NTT_Q);
  if (!(res >> 16U == 0U))
  {
    EURYDICE_ASSERT(res >> 16U == 65535U, "panic!");
  }
  uint32_t res0 = core_num__u32_8__wrapping_add(res, SYMCRUST_NTT_Q & res >> 16U);
  ...
  for (size_t i = (size_t)0U; i < SYMCRUST_KEY_MLWE_POLYNOMIAL_COEFFICIENTS; i++)
  {
    ...
    while (true)
    {
      if (x4[0U] == 0U)
      {
        ...
        x4[0U] = 32U;
        uint32_t n_bits_to_decode = symcrust_ntt_min(n_bits_per_coefficient - x6[0U], x4[0U]);
    ...
    )
    {
      ...
      coefficient =
        symcrust_ntt_mod_reduce(/* modular reduction by conditional subtraction */ coefficient );
...
)
{
  ...
  EURYDICE_ASSERT(n_rows <= SYMCRUST_NTT_MATRIX_MAX_NROWS, "panic!");
  EURYDICE_ASSERT(n_bits_per_coefficient > 0U, "panic!");
  EURYDICE_ASSERT(n_bits_per_coefficient <= 12U, "panic!");
  ...
  for (size_t i = (size_t)0U; i < n_rows; i++)
  {
    ...
    symcrust_common_Error
    sc_error =
      symcrust_ntt_poly_element_decode_and_decompress(uu____0,
        n_bits_per_coefficient,
...
const
uint16_t
symcrust_ntt_ZETA_BIT_REV_TIMES_R[128U] =
  {
...
const
uint16_t
symcrust_ntt_ZETA_BIT_REV_TIMES_R_TIMES_NEG_Q_INV_MOD_R[128U] =
  {
...
KRML_MUSTINLINE uint32_t symcrust_ntt_mont_mul(uint32_t a, uint32_t b, uint32_t b_mont)
{
  EURYDICE_ASSERT(a < SYMCRUST_NTT_Q, "panic!");
  EURYDICE_ASSERT(b < SYMCRUST_NTT_Q, "panic!");
  EURYDICE_ASSERT(b_mont <= SYMCRUST_NTT_RMASK, "panic!");
  EURYDICE_ASSERT(b_mont == (b * SYMCRUST_NTT_NEG_Q_INV_MOD_R & SYMCRUST_NTT_RMASK), "panic!");
  uint32_t res = a * b;
  uint32_t inv = a * b_mont & SYMCRUST_NTT_RMASK;
  res = res + inv * SYMCRUST_NTT_Q;
  EURYDICE_ASSERT((res & SYMCRUST_NTT_RMASK) == 0U, "panic!");
  res = res >> (uint32_t)SYMCRUST_NTT_RLOG2;
  return symcrust_ntt_mod_reduce(res);
}

KRML_MUSTINLINE uint32_t symcrust_ntt_mod_sub(uint32_t a, uint32_t b)
{
  EURYDICE_ASSERT(a < SYMCRUST_NTT_Q, "panic!");
  EURYDICE_ASSERT(b < SYMCRUST_NTT_Q, "panic!");
...
KRML_MUSTINLINE uint32_t symcrust_ntt_mod_add(uint32_t a, uint32_t b)
{
  EURYDICE_ASSERT(a < SYMCRUST_NTT_Q, "panic!");
  EURYDICE_ASSERT(b < SYMCRUST_NTT_Q, "panic!");
  return symcrust_ntt_mod_reduce(a + b);
}
...
void symcrust_ntt_poly_element_ntt_layer_c(uint16_t *pe_src, size_t k, size_t len)
{
  ...
  {
    uint32_t twiddle_factor = (uint32_t)symcrust_ntt_ZETA_BIT_REV_TIMES_R[k];
    uint32_t
    twiddle_factor_mont = (uint32_t)symcrust_ntt_ZETA_BIT_REV_TIMES_R_TIMES_NEG_Q_INV_MOD_R[k];
    k++;
    for (size_t j = (size_t)0U; j < len; j++)
    {
      ...
      uint32_t c1_times_twiddle = symcrust_ntt_mont_mul(c1, twiddle_factor, twiddle_factor_mont);
      c1 = symcrust_ntt_mod_sub(c0, c1_times_twiddle);
      c0 = symcrust_ntt_mod_add(c0, c1_times_twiddle);
...
symcrust_ntt_poly_element_ntt_layer(uint16_t *pe_src, size_t k, size_t len)
{
  symcrust_ntt_poly_element_ntt_layer_c(pe_src, k, len);
}

void symcrust_ntt_poly_element_ntt(uint16_t *pe_src)
{
  symcrust_ntt_poly_element_ntt_layer(pe_src, (size_t)1U, (size_t)128U);
  symcrust_ntt_poly_element_ntt_layer(pe_src, (size_t)2U, (size_t)64U);
  symcrust_ntt_poly_element_ntt_layer(pe_src, (size_t)4U, (size_t)32U);
  symcrust_ntt_poly_element_ntt_layer(pe_src, (size_t)8U, (size_t)16U);
  symcrust_ntt_poly_element_ntt_layer(pe_src, (size_t)16U, (size_t)8U);
  symcrust_ntt_poly_element_ntt_layer(pe_src, (size_t)32U, (size_t)4U);
  symcrust_ntt_poly_element_ntt_layer(pe_src, (size_t)64U, (size_t)2U);
}
...
void symcrust_ntt_vector_ntt(Eurydice_slice pv_src)
{
  ...
  for (size_t i = (size_t)0U; i < n_rows; i++)
  {
    symcrust_ntt_poly_element_ntt(Eurydice_slice_index(pv_src,
        i,
        uint16_t [256U],
        uint16_t (*)[256U]));
  }
...
const
uint16_t
symcrust_ntt_ZETA_TO_TIMES_BIT_REV_PLUS_1_TIMES_R[128U] =
  {
  ...
  for (size_t i = (size_t)0U; i < SYMCRUST_KEY_MLWE_POLYNOMIAL_COEFFICIENTS / (size_t)2U; i++)
  {
    ...
    a1b1zetapow =
      /* now multiply a1b1 by power of zeta */ a1b10  *
        (uint32_t)symcrust_ntt_ZETA_TO_TIMES_BIT_REV_PLUS_1_TIMES_R[i];
...
)
{
  for (size_t i = (size_t)0U; i < SYMCRUST_KEY_MLWE_POLYNOMIAL_COEFFICIENTS; i++)
  {
    ...
    uint32_t
    inv =
      core_num__u32_8__wrapping_mul(/* montgomery reduce sum of products */ a ,
        SYMCRUST_NTT_NEG_Q_INV_MOD_R)
      & SYMCRUST_NTT_RMASK;
    ...
    c = core_num__u32_8__wrapping_add(c, SYMCRUST_NTT_Q & c >> 16U);
...
)
{
  ...
  for (size_t i = (size_t)0U; i < n_rows; i++)
  {
    symcrust_ntt_poly_element_mul_and_accumulate(Eurydice_slice_index(pv_src1,
        i,
        uint16_t [256U],
        uint16_t (*)[256U]),
  ...
  symcrust_ntt_montgomery_reduce_and_add_poly_element_accumulator_to_poly_element(/* write accumulator to dest and zero accumulator */
      pa_tmp
    ,
    pe_dst);
}
...
void symcrust_ntt_poly_element_intt_layer_c(uint16_t *pe_src, size_t k, size_t len)
{
  for (size_t start = (size_t)0U; start < (size_t)256U; start = start + (size_t)2U * len)
  {
    ...
    for (size_t j = (size_t)0U; j < len; j++)
    {
      ...
      uint32_t c1 = (uint32_t)pe_src[start + j + len];
      EURYDICE_ASSERT(c1 < SYMCRUST_NTT_Q, "panic!");
      uint32_t tmp = symcrust_ntt_mod_add(c0, c1);
      c1 = symcrust_ntt_mod_sub(c1, c0);
      c1 = symcrust_ntt_mont_mul(c1, twiddle_factor, twiddle_factor_mont);
...
KRML_MUSTINLINE void
symcrust_ntt_poly_element_intt_layer(uint16_t *pe_src, size_t k, size_t len)
{
  symcrust_ntt_poly_element_intt_layer_c(pe_src, k, len);
}

void symcrust_ntt_poly_element_intt_and_mul_r(uint16_t *pe_src)
{
  symcrust_ntt_poly_element_intt_layer(pe_src, (size_t)127U, (size_t)2U);
  symcrust_ntt_poly_element_intt_layer(pe_src, (size_t)63U, (size_t)4U);
  symcrust_ntt_poly_element_intt_layer(pe_src, (size_t)31U, (size_t)8U);
  symcrust_ntt_poly_element_intt_layer(pe_src, (size_t)15U, (size_t)16U);
  symcrust_ntt_poly_element_intt_layer(pe_src, (size_t)7U, (size_t)32U);
  symcrust_ntt_poly_element_intt_layer(pe_src, (size_t)3U, (size_t)64U);
  symcrust_ntt_poly_element_intt_layer(pe_src, (size_t)1U, (size_t)128U);
  for (size_t i = (size_t)0U; i < SYMCRUST_KEY_MLWE_POLYNOMIAL_COEFFICIENTS; i++)
  {
    uint32_t
    uu____0 =
      symcrust_ntt_mont_mul((uint32_t)pe_src[i],
        SYMCRUST_NTT_INTT_FIXUP_TIMES_RSQR,
        SYMCRUST_NTT_INTT_FIXUP_TIMES_RSQR_TIMES_NEQ_Q_INV_MOD_R);
...
void symcrust_ntt_poly_element_sub(uint16_t *pe_src1, uint16_t *pe_src2, uint16_t *pe_dst)
{
  for (size_t i = (size_t)0U; i < SYMCRUST_KEY_MLWE_POLYNOMIAL_COEFFICIENTS; i++)
  {
    uint32_t uu____0 = symcrust_ntt_mod_sub((uint32_t)pe_src1[i], (uint32_t)pe_src2[i]);
...
)
{
  ...
  for (size_t i = (size_t)0U; i < SYMCRUST_KEY_MLWE_POLYNOMIAL_COEFFICIENTS; i++)
  {
    ...
    )
    {
      ...
      coefficient =
        (uint32_t)(multiplication >>
          (uint32_t)(SYMCRUST_NTT_COMPRESS_SHIFTCONSTANT - (n_bits_per_coefficient + 1U)));
      /* add "half" to round to nearest integer */
      coefficient++;
    ...
    while (true)
    {
      uint32_t n_bits_to_encode = symcrust_ntt_min(x4[0U], 32U - x3[0U]);
...
)
{
  ...
  if (!(eta == 3U))
  {
    for (size_t i = (size_t)0U; i < SYMCRUST_KEY_MLWE_POLYNOMIAL_COEFFICIENTS; i = i + (size_t)8U)
    {
      ...
      KRML_MAYBE_FOR8(j,
        ...
        coefficient =
          core_num__u32_8__wrapping_add(coefficient,
            SYMCRUST_NTT_Q & coefficient >> 16U);
        EURYDICE_ASSERT(coefficient < SYMCRUST_NTT_Q, "panic!");
        /* each coefficient is formed by taking the difference of two consecutive slices of eta bits the first eta bits are positive, the second eta bits are negative */
          pe_dst
        [i + j]
  ...
  for (size_t i = (size_t)0U; i < SYMCRUST_KEY_MLWE_POLYNOMIAL_COEFFICIENTS; i = i + (size_t)4U)
  {
    ...
    KRML_MAYBE_FOR4(j,
      ...
      coefficient = core_num__u32_8__wrapping_add(coefficient, SYMCRUST_NTT_Q & coefficient >> 16U);
      EURYDICE_ASSERT(coefficient < SYMCRUST_NTT_Q, "panic!");
...
)
{
  ...
  *src1 = Eurydice_slice_index(pm_src1, i * n_rows + j, uint16_t [256U], uint16_t (*)[256U]);
  symcrust_ntt_poly_element_mul_and_accumulate(src1, pe_src2, pa_tmp);
}
...
)
{
  ...
  EURYDICE_ASSERT(n_rows0 <= SYMCRUST_NTT_MATRIX_MAX_NROWS, "panic!");
  _size_t__x2 uu____0;
  ...
  for (size_t i = (size_t)0U; i < n_rows0; i++)
  {
    ...
    {
      symcrust_ntt_poly_element_mul_and_accumulate_aux(pm_src1,
        n_rows0,
        i,
        j,
...
void symcrust_ntt_vector_intt_and_mul_r(Eurydice_slice pv_src)
{
  ...
  for (size_t i = (size_t)0U; i < n_rows; i++)
  {
    symcrust_ntt_poly_element_intt_and_mul_r(Eurydice_slice_index(pv_src,
        i,
        uint16_t [256U],
        uint16_t (*)[256U]));
  }
...
void symcrust_ntt_poly_element_add(uint16_t *pe_src1, uint16_t *pe_src2, uint16_t *pe_dst)
{
  for (size_t i = (size_t)0U; i < SYMCRUST_KEY_MLWE_POLYNOMIAL_COEFFICIENTS; i++)
  {
    uint32_t uu____0 = symcrust_ntt_mod_add((uint32_t)pe_src1[i], (uint32_t)pe_src2[i]);
    pe_dst[i] = (uint16_t)uu____0;
  }
}
...
)
{
  ...
  for (size_t i = (size_t)0U; i < n_rows; i++)
  {
    ...
    symcrust_ntt_poly_element_compress_and_encode(uu____0,
      uu____1,
...
)
{
  ...
  if (!(cb_agreed_secret != SYMCRUST_MLKEM_SIZEOF_AGREED_SECRET))
  {
    if (!(cb_ciphertext != cb_u + cb_v))
    {
      ...
      for (uint8_t i = 0U; i < n_rows; i = (uint32_t)i + 1U)
      {
        ...
        symcrust_hash_shake256_extract(uu____4,
          Eurydice_array_to_subslice2(cbd_sample_buffer,
            ...
            uint8_t),
          false);
        symcrust_ntt_poly_element_sample_cbd_from_bytes(Eurydice_array_to_slice((size_t)193U,
            cbd_sample_buffer,
            uint8_t),
          (uint32_t)n_eta1,
          Eurydice_slice_index(pvr_inner, (size_t)i, uint16_t [256U], uint16_t (*)[256U]));
      }
      symcrust_ntt_vector_ntt(/* Perform NTT on rInner */ pvr_inner );
      symcrust_ntt_vector_set_zero(/* Set pv_tmp to 0 TODO: write a helper function -- any way to do this better? */
          pv_tmp
        );
      symcrust_ntt_matrix_vector_mont_mul_and_add(symcrust_key_atranspose_mut_fd(/* pv_tmp.copy_from_slice(&vec![POLYELEMENT_ZERO; n_rows as usize].into_boxed_slice()); VectorSetZero( pv_tmp ); pv_tmp = (Atranspose o rInner) ./ R */
            pk_mlkem_key
          ),
        pvr_inner,
        pv_tmp,
        pa_tmp,
        n_rows);
      symcrust_ntt_vector_intt_and_mul_r(/* pv_tmp = INTT(Atranspose o rInner) */ pv_tmp );
      for (uint8_t i = 0U; i < n_rows; i = (uint32_t)i + 1U)
      {
        ...
        memcpy(copy,
          Eurydice_slice_index(pv_tmp,
            ...
            uint16_t (*)[256U]),
          (size_t)256U * sizeof (uint16_t));
        symcrust_ntt_poly_element_add(copy,
          pe_tmp0,
          Eurydice_slice_index(pv_tmp, (size_t)i, uint16_t [256U], uint16_t (*)[256U]));
      }
      symcrust_ntt_vector_compress_and_encode(/* pv_tmp = u = INTT(Atranspose o rInner) + e1 Compress and encode u into prefix of ciphertext */
          pv_tmp
        ,
        (uint32_t)n_bits_of_u,
        Eurydice_slice_subslice2(pb_ciphertext, (size_t)0U, cb_u, uint8_t));
      symcrust_ntt_vector_mont_dot_product(symcrust_key_t_mut_fd(/* pe_tmp0 = (t o r) ./ R */
            pk_mlkem_key
          ),
        pvr_inner,
        pe_tmp0,
        pa_tmp);
      symcrust_ntt_poly_element_intt_and_mul_r(/* pe_tmp0 = INTT(t o r) */ pe_tmp0 );
      ...
      symcrust_ntt_poly_element_add(copy, pe_tmp1, pe_tmp0);
      LowStar_Ignore_ignore(symcrust_ntt_poly_element_decode_and_decompress(Eurydice_array_to_slice((size_t)32U,
      ...
      symcrust_ntt_poly_element_add(/* FIXME (same as above) */ copy0 , pe_tmp1, pe_tmp0);
      /* Compress and encode v into remainder of ciphertext */
      uint16_t *uu____9 = pe_tmp0;
      uint32_t uu____10 = (uint32_t)n_bits_of_v;
      symcrust_ntt_poly_element_compress_and_encode(uu____9,
        uu____10,
      ...
      if (!(cb_agreed_secret != SYMCRUST_MLKEM_SIZEOF_AGREED_SECRET))
      {
        if (!(cb_ciphertext != cb_u + cb_v))
        {
          if (pk_mlkem_key.ptr->has_private_key)
          {
            ...
            symcrust_common_Error
            sc_error =
              symcrust_ntt_vector_decode_and_decompress(Eurydice_slice_subslice2(/* Decode and decompress u */
                    pb_read_ciphertext
                  ,
                  (size_t)0U,
                  cb_u,
            ...
            symcrust_ntt_vector_ntt(/* Perform NTT on u */ pvu );
            symcrust_ntt_vector_mont_dot_product(symcrust_key_s_mut_fd(/* pe_tmp0 = (s o NTT(u)) ./ R */
                  pk_mlkem_key
                ),
              pvu,
              pe_tmp0,
              pa_tmp);
            symcrust_ntt_poly_element_intt_and_mul_r(/* pe_tmp0 = INTT(s o NTT(u)) */ pe_tmp0 );
            symcrust_common_Error
            sc_error0 =
              symcrust_ntt_poly_element_decode_and_decompress(Eurydice_slice_subslice_from(/* Decode and decompress v */
                    pb_read_ciphertext
                  ,
                  cb_u,
                  uint8_t,
            ...
            memcpy(copy, pe_tmp0, (size_t)256U * sizeof (uint16_t));
            symcrust_ntt_poly_element_sub(pe_tmp1, copy, pe_tmp0);
            symcrust_ntt_poly_element_compress_and_encode(/* pbDecryptedRandom = m' = Encoding of w */
                pe_tmp0
              ,
              1U,
...
)
{
  ...
  for (uint8_t i = 0U; i < n_rows; i = (uint32_t)i + 1U)
  {
    ...
    for (uint8_t j = 0U; j < n_rows; j = (uint32_t)j + 1U)
    {
      ...
      symcrust_ntt_poly_element_sample_ntt_from_shake128(p_shake_state_work,
...
void symcrust_ntt_poly_element_mul_r(uint16_t *pe_src, uint16_t *pe_dst)
{
  for (size_t i = (size_t)0U; i < SYMCRUST_KEY_MLWE_POLYNOMIAL_COEFFICIENTS; i++)
  {
    ...
    uu____0 =
      symcrust_ntt_mont_mul((uint32_t)pe_src[i],
        SYMCRUST_NTT_RSQR,
        SYMCRUST_NTT_RSQR_TIMES_NEG_Q_INV_MOD_R);
    pe_dst[i] = (uint16_t)uu____0;
  }
}
...
void symcrust_ntt_vector_mul_r(Eurydice_slice pv_src, Eurydice_slice pv_dst)
{
  ...
  for (size_t i = (size_t)0U; i < n_rows; i++)
  {
    symcrust_ntt_poly_element_mul_r(Eurydice_slice_index(pv_src,
        i,
        uint16_t [256U],
        uint16_t (*)[256U]),
      Eurydice_slice_index(pv_dst, i, uint16_t [256U], uint16_t (*)[256U]));
...
)
{
  ...
  for (uint8_t i = 0U; i < n_rows; i = (uint32_t)i + 1U)
  {
    ...
    symcrust_ntt_poly_element_sample_cbd_from_bytes(uu____9,
      uu____10,
  ...
  for (uint8_t i = 0U; i < n_rows; i = (uint32_t)i + 1U)
  {
    ...
    symcrust_ntt_poly_element_sample_cbd_from_bytes(uu____13,
      uu____14,
  ...
  symcrust_ntt_vector_ntt(symcrust_key_s_mut_fd(pk_mlkem_key));
  symcrust_ntt_vector_ntt(symcrust_key_t_mut_fd(pk_mlkem_key));
  Eurydice_slice
  pv_tmp =
    Eurydice_array_to_subslice2(p_comp_temps->ab_vector_buffer0,
      (size_t)0U,
      (size_t)n_rows,
      uint16_t [256U]);
  symcrust_ntt_vector_mul_r(symcrust_key_s_mut_fd(pk_mlkem_key), pv_tmp);
  ...
  symcrust_ntt_matrix_vector_mont_mul_and_add(uu____16,
    Eurydice_array_to_subslice2(p_comp_temps->ab_vector_buffer0,
      (size_t)0U,
      (size_t)n_rows,
      uint16_t [256U]),
    ...
    pa_tmp,
    n_rows);
  symcrust_ntt_matrix_transpose(symcrust_key_atranspose_mut_fd(pk_mlkem_key), n_rows);
  ...
  symcrust_ntt_vector_compress_and_encode(uu____18,
    12U,
      ...
      if (p_comp_temps.tag == core_result_Ok)
      {
        ...
        else if (format == symcrust_key_Format_DecapsulationKey)
        {
          ...
          else
          {
            ...
            symcrust_common_Error
            sc_error =
              symcrust_ntt_vector_decode_and_decompress(uu____9,
                12U,
            ...
            else
            {
              ...
              symcrust_common_Error
              sc_error0 =
                symcrust_ntt_vector_decode_and_decompress(Eurydice_array_to_subslice2(encoded_t,
                    (size_t)0U,
                    cb_encoded_vector,
                    uint8_t),
                  12U,
      ...
      if (p_comp_temps.tag == core_result_Ok)
      {
        ...
        else if (format == symcrust_key_Format_DecapsulationKey)
        {
          ...
          else
          {
            ...
            symcrust_common_Error
            sc_error =
              symcrust_ntt_vector_decode_and_decompress(uu____23,
                12U,
                symcrust_key_s_mut_fd(pk_mlkem_key));
            /* original Rust expression is not an lvalue in C */
            symcrust_common_Error lvalue0 = symcrust_common_Error_NoError;
...
)
{
  ...
  else if (format == symcrust_key_Format_DecapsulationKey)
  {
    ...
    else if (pk_mlkem_key.ptr->has_private_key)
    {
      ...
      symcrust_ntt_vector_compress_and_encode(uu____15,
        12U,
...
symcrust_ntt_vector_add(Eurydice_slice pv_src1, Eurydice_slice pv_src2, Eurydice_slice pv_dst)
{
  ...
  for (size_t i = (size_t)0U; i < n_rows; i++)
  {
    symcrust_ntt_poly_element_add(Eurydice_slice_index(pv_src1,
        i,
        uint16_t [256U],
        uint16_t (*)[256U]),
      Eurydice_slice_index(pv_src2, i, uint16_t [256U], uint16_t (*)[256U]),
...
symcrust_ntt_vector_sub(Eurydice_slice pv_src1, Eurydice_slice pv_src2, Eurydice_slice pv_dst)
{
  ...
  for (size_t i = (size_t)0U; i < n_rows; i++)
  {
    symcrust_ntt_poly_element_sub(Eurydice_slice_index(pv_src1,
        i,
        uint16_t [256U],
        uint16_t (*)[256U]),
      Eurydice_slice_index(pv_src2, i, uint16_t [256U], uint16_t (*)[256U]),
