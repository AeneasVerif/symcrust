/* 
  ...
  KaRaMeL invocation: /Users/jonathan/Code/eurydice/eurydice symcrust.llbc --output c/ --log Phase2.9
  F* version: <unknown>
...
)
{
  ...
  for (size_t i = (size_t)0U; i < SYMCRUST_NTT_MLWE_POLYNOMIAL_COEFFICIENTS; i++)
  {
    ...
    {
      uint64_t multiplication = (uint64_t)coefficient * (uint64_t)SYMCRUST_NTT_COMPRESS_MULCONSTANT;
      coefficient =
