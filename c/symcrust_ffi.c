...
{
  Eurydice_dst_6f
  *k0 = alloc_boxed__alloc__boxed__Box_T___from_raw(k, Eurydice_dst_6f, Eurydice_dst_6f *);
  Eurydice_slice
  agreed_secret =
  ...
  alloc_boxed__alloc__boxed__Box_T___into_raw(k0, Eurydice_dst_6f, Eurydice_dst_6f *);
  return r;
}
...
- N= 1
*/
inline core_fmt_Arguments core_fmt_rt_new_const_21_74(Eurydice_arr_7d *pieces)
{
  Eurydice_arr_7b
  uu____0 = Eurydice_empty_array((void *)0U, core_fmt_rt_ArgumentType, Eurydice_arr_7b);
  return
    (
...
void symcrust_ffi_SymCryptMlKemSelftest(void)
{
  ...
  std_io_stdio__print(core_fmt_rt_new_const_21_74(&lvalue));
}
...
with types Eurydice_dst symcrust_key_PreKey2 Eurydice_derefed_slice Eurydice_arr uint16_t[[$256size_t]]

*/
static Eurydice_dst_6f *null_mut_98(void)
{
  return NULL;
}

Eurydice_dst_6f *symcrust_ffi_SymCryptMlKemkeyAllocate(int32_t params)
{
  core_result_Result_fa uu____0 = symcrust_ffi_try_from_1e(params);
  Eurydice_dst_6f *uu____1;
  if (uu____0.tag == core_result_Ok)
  {
    ...
    {
      Eurydice_dst_6f k = uu____2.val.case_Ok;
      uu____1 =
...
void symcrust_ffi_SymCryptMlKemkeyFree(Eurydice_dst_6f *k)
{
  alloc_boxed__alloc__boxed__Box_T___from_raw(k, Eurydice_dst_6f, Eurydice_dst_6f *);
}

symcrust_common_Error symcrust_ffi_SymCryptMlKemkeyGenerate(Eurydice_dst_6f *k, uint32_t flags)
{
  Eurydice_dst_6f
  *k0 = alloc_boxed__alloc__boxed__Box_T___from_raw(k, Eurydice_dst_6f, Eurydice_dst_6f *);
