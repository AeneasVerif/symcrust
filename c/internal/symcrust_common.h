...
#define core_fmt_rt_Is 0
#define core_fmt_rt_Param 1
#define core_fmt_rt_Implied 2

typedef uint8_t core_fmt_rt_Count_tags;

typedef struct core_fmt_rt_Count_s
{
  core_fmt_rt_Count_tags tag;
  union {
    uint16_t case_Is;
    size_t case_Param;
  }
...
typedef struct core_fmt_rt_Placeholder_s
{
  size_t position;
  uint32_t flags;
  core_fmt_rt_Count precision;
  core_fmt_rt_Count width;
}
core_fmt_rt_Placeholder;

#define core_fmt_rt_Placeholder0 0
#define core_fmt_rt_Count0 1

typedef uint8_t core_fmt_rt_ArgumentType_tags;

typedef struct core_fmt_rt_ArgumentType_s
{
  core_fmt_rt_ArgumentType_tags tag;
  union {
    struct
    {
      core_ptr_non_null_NonNull value;
      core_result_Result_10 (*formatter)(core_ptr_non_null_NonNull x0, core_fmt_Formatter *x1);
    }
    case_Placeholder;
    uint16_t case_Count;
  }
...
core_fmt_rt_ArgumentType;

typedef core_fmt_rt_ArgumentType core_fmt_rt_Argument;

#define core_option_None 0
#define core_option_Some 1

typedef uint8_t core_option_Option_f0_tags;

/**
A monomorphic instance of core.option.Option
with types Eurydice_slice core_fmt_rt_Placeholder

*/
typedef struct core_option_Option_f0_s
{
  core_option_Option_f0_tags tag;
  Eurydice_slice f0;
}
core_option_Option_f0;

typedef struct core_fmt_Arguments_s
{
  Eurydice_slice pieces;
  core_option_Option_f0 fmt;
  Eurydice_slice args;
}
core_fmt_Arguments;
...
static inline uint16_t core_num__u16__from_le_bytes(Eurydice_arr_8b x0);

static inline uint32_t core_num__u32__from_le_bytes(Eurydice_arr_e9 x0);
