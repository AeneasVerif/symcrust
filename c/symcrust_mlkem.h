...
with types Eurydice_derefed_slice uint16_t[256size_t]
...
typedef symcrust_key_PreKey2_0e symcrust_key_Key;

typedef symcrust_key_PreKey2_0e symcrust_key_Key2;
