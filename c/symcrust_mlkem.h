...
#define SYMCRUST_KEY_KEY_ALLOCATE2_PARAMS_1 (symcrust_key_get_internal_params_from_params(symcrust_key_Params_MlKem768))

#define SYMCRUST_KEY_KEY_ALLOCATE2_N_ROWS_1 ((size_t)SYMCRUST_KEY_KEY_ALLOCATE2_PARAMS_1.n_rows)

#define SYMCRUST_KEY_KEY_ALLOCATE2_PARAMS_2 (symcrust_key_get_internal_params_from_params(symcrust_key_Params_MlKem1024))

#define SYMCRUST_KEY_KEY_ALLOCATE2_N_ROWS_2 ((size_t)SYMCRUST_KEY_KEY_ALLOCATE2_PARAMS_2.n_rows)
